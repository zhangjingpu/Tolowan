...
class AdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $content['termHandle'] = array(
            ...
            'size' => '6',
            'content' => array(
                'termForm' => $entity->addForm($contentModel)->renderForm(),
            ),
        );
    ...
    public function editorAction()
    {
        ...
        $entity = $this->entityManager->get('term');
        $termEditorArr = Config::get('taxonomy.termForm');
        $termEditorArr['formId'] = 'termEditor';
        $termEditorArr['settings']['id'] = $id;
        $termEditorForm = $entity->editForm(null,$id);
        if ($termEditorForm->isValid()) {
            $entity->save($termEditorForm);
