...
$settings = array(
    ...
    'adminModulesInstall' => array(
        'httpMethods' => null,
        'pattern' => '/' . ADMIN_PREFIX . '/module/install/{module:([0-9a-zA-Z]{2,})}',
        'paths' => array(
            'controller' => 'Admin',
            'module' => 'Core',
    ...
    'adminThemesEnable' => array(
        'httpMethods' => null,
        'pattern' => '/' . ADMIN_PREFIX . '/themes/enable/{theme:([0-9a-zA-Z]{2,})}',
        'paths' => array(
            'controller' => 'Admin',
            'module' => 'core',
            'action' => 'ThemesEnable',
    ...
    'adminThemesDisable' => array(
        'httpMethods' => null,
        'pattern' => '/' . ADMIN_PREFIX . '/themes/disable/{theme:([0-9a-zA-Z]{2,})}',
        'paths' => array(
            'controller' => 'Admin',
            'module' => 'core',
    ...
    'adminThemesInstall' => array(
        'httpMethods' => null,
        'pattern' => '/' . ADMIN_PREFIX . '/themes/install/{theme:([0-9a-zA-Z]{2,})}',
        'paths' => array(
            'controller' => 'Admin',
            'module' => 'core',
    ...
    'adminThemesSetDefault' => array(
        'httpMethods' => null,
        'pattern' => '/' . ADMIN_PREFIX . '/themes/setDefault/{theme:([0-9a-zA-Z]{2,})}',
        'paths' => array(
            'controller' => 'Admin',
            'module' => 'core',
    ...
    'adminThemesUnsetDefault' => array(
        'httpMethods' => null,
        'pattern' => '/' . ADMIN_PREFIX . '/themes/unsetDefault/{theme:([0-9a-zA-Z]{2,})}',
        'paths' => array(
            'controller' => 'Admin',
            'module' => 'core',
