...
class AutocompleteSingle extends Element
{
    ...
    public function render($attributes = null)
    {
        ...
        $imgListHtml = '<div class="chosen-container chosen-container-single" title="" id="form_field_select_3_chosen"><a tabindex="-1" class="chosen-single"><span>North Dakota</span><div><b></b></div></a><div class="chosen-drop"><div class="chosen-search"><input type="text" autocomplete="off"></div><ul class="chosen-results"></ul></div></div>';
