...
scription;
        $di->getShared('assets')
            ->addJs('bootstrap-datetimepicker', '/library/bootstrap-datetimepicker/bootstrap-datetimepicker.min.js', 'footer')
            ->addJs('bootstrap-datetimepicker-zh', '/library/bootstrap-datetimepicker/locales/bootstrap-datetimepicker.zh-CN.js', 'footer')
            ->addCss('bootstrap-datetimepicker', '/library/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css', 'footer')
    ...
    {
        $field = new \Phalcon\Forms\Element\TextArea($element['name'], $element['attributes']);
        return $field;
    }
