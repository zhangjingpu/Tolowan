...
class View extends Pview
{
    ...
    public function setBaseTemplate($name = 'page')
    {
        $templates = $this->setTemplateName($name);
    ...
    public function setTemplateName($name)
    {
        ...
        foreach ($defaultSchema as $value) {
            $urlSchema[] = $value;
            $urlSchema[] = $value . '--' . $this->_module;
            $urlSchema[] = $value . '--' . $this->_module . '--' . $this->_controllerName;
            $urlSchema[] = $value . '--' . $this->_module . '--' . $this->_controllerName . '--' . $this->_actionName;
        }
