...
var Grid = fc.Grid = RowRenderer.extend({
	...
	// Called when the grid's Rsources need to be cleaned up
	destroy: function() {
		this.unbindHandlers();
	},
    ...
    /* Events-rendering and event-interaction methods for the abstract Grid class
----------------------------------------------------------------------------------------------------------------------*/
...
var TimeGrid = Grid.extend({
    ...
    /* Events-rendering methods for the TimeGrid class
----------------------------------------------------------------------------------------------------------------------*/
...
function EventManager(options) { // assumed to be a calendar
			...
			if (fetchID == currentFetchID) {
				...
				if (eventInputs) {
					for (i = 0; i < eventInputs.length; i++) {
						...
						if (isArraySource) { // array sources have already been convert to Events Objects
	...
	function buildEventSource(sourceInput) { // will return undefined if invalid source
		...
		if (source) {
			...
			// for array sources, we convert to standard Events Objects up front
	...
	function removeEvents(filter) {
		...
		// This works because they have been converted to official Events Objects up front.
	...
	// Given a raw object with key/value properties, returns an "abstract" Events object.
	...
	// Accepts an Events object, or a plain object with event-ish properties.
