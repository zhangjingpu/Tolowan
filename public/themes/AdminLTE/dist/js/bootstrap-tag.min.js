!function(c) {
    ...
    b.prototype = {constructor: b, show: function() {
            ...
            d.input = c('<textarea rows="1" class="form-control" type="text"></textarea>').attr("placeholder", d.options.placeholder).insertAfter(d.element).on("focus", function() {
            ...
            })).append('<input type="hidden" name="tag[]" value="'+e+'" />').insertBefore(d.element)
        }, add: function(g) {
            var f = this;
