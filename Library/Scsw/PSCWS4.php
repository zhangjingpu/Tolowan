...
class PSCWS4
{
    ...
    // 构造函数
    public function PSCWS4($charset = 'utf8')
    {
        $this->_xd = false;
    ...
    // 设置词典
    public function set_dict($fpath = ROOT_DIR.'Library/Scsw/etc/dict.utf8.xdb')
    {
        $xdb = new XDB_R;
        if (!$xdb->Open($fpath)) {
            return false;
    ...
    // 设置规则集
    public function set_rule($fpath = ROOT_DIR.'Library/Scsw/etc/rules.utf8.ini')
    {
